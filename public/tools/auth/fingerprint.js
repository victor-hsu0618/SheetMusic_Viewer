/**
 * Unified SHA-256 fingerprint for PDF identification (Standalone Version for Tools).
 * This logic matches src/fingerprint.js exactly to ensure identical hashes.
 */
const Fingerprint = (() => {
