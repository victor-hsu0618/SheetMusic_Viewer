...
export const TOOLSETS = [
    ...
    },
    {
        ...
        tools: [
            ...
            { id: 'up-bow', label: 'Up', icon: '<path d="M8 9.5l4 7l4-7" fill="none" stroke="currentColor" stroke-width="1.2" />', draw: { type: 'path', data: 'M -0.26 -0.3 L 0 0.3 L 0.26 -0.3' } },
            { id: 'thumb', label: 'Thumb', icon: '<ellipse cx="12" cy="11" rx="1.9" ry="3.2" fill="none" stroke="currentColor" stroke-width="0.8" /><line x1="12" y1="14.2" x2="12" y2="17.4" stroke="currentColor" stroke-width="0.8" />', draw: { type: 'complex', variant: 'thumb' } },
