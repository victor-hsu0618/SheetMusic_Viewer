...
export const TOOLSETS = [
    {
        ...
        tools: [
            ...
            { id: 'quick-text', label: 'Text', isTextTrigger: true, icon: '<path d="M4 7V4h16v3M12 4v16m-4 0h8" fill="none" stroke="currentColor" stroke-width="2" />', draw: { type: 'text', content: '', size: 20 } },
