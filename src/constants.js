...
export const TOOLSETS = [
    ...
    },
    {
        ...
        tools: [
            ...
            { id: 'thumb', label: 'Thumb', icon: '<ellipse cx="12" cy="11" rx="1.9" ry="3.2" fill="none" stroke="currentColor" stroke-width="0.8" /><line x1="12" y1="14.2" x2="12" y2="17.4" stroke="currentColor" stroke-width="0.8" />', draw: { type: 'complex', variant: 'thumb', size: 12 } },
