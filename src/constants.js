...
export const TOOLSETS = [
    ...
    },
    {
        ...
        tools: [
            ...
            { id: 'natural', label: 'Natural', icon: '<text x="12" y="17" font-family="serif" font-weight="500" text-anchor="middle" fill="currentColor" stroke="none">♮</text>', draw: { type: 'text', content: '♮', font: '500', size: 20, fontFace: 'serif' } }        ]
    },
    {
        name: 'Text',
        type: 'text',
