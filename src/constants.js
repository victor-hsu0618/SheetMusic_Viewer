...
export const TOOLSETS = [
    ...
    },
    {
        ...
        type: 'draw',
        tools: [
            { id: 'pen',        label: 'Ballpoint', row: 1, icon: '<path d="M14.5 4.5L19.5 9.5L10.5 18.5L6 19L6.5 14.5L14.5 4.5Z" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linejoin="round"/><circle cx="18.1" cy="8.1" r="1.2" fill="currentColor"/><path d="M4 21h7" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/>', draw: { type: 'path' } },
            { id: 'fine-pen',   label: 'Fine',      row: 1, icon: '<path d="M15.5 4L19.8 8.3L10.2 17.9L7.2 18.3L7.6 15.3L15.5 4Z" fill="none" stroke="currentColor" stroke-width="1" stroke-linejoin="round"/><path d="M18.6 7.1L20.3 5.4" stroke="currentColor" stroke-width="0.9" stroke-linecap="round"/><path d="M5 21h8" stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/>', draw: { type: 'path' } },
            { id: 'marker-pen', label: 'Marker',    row: 1, icon: '<rect x="9" y="3" width="6" height="11" rx="1.6" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M9.5 14h5l1.5 3.5L12 21l-4-3.5L9.5 14Z" fill="currentColor" opacity="0.55" stroke="currentColor" stroke-width="1.1"/><rect x="4" y="19" width="8" height="3.2" rx="1.1" fill="currentColor" opacity="0.85"/>', draw: { type: 'path' } },
            { id: 'brush-pen',    label: 'Brush',    row: 1, icon: '<path d="M16.5 4c1.1-.8 2.7.6 2.3 1.8-.2.5-.6 1-1.1 1.5L9.2 15.8c-.9.9-2.2 1.7-4.2 3.2.9-1.8 1.5-3.4 2.5-4.4L16.5 4Z" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M4 21c1.4-1.6 3.2-2.6 5.5-2.8 1.4-.1 2.8.1 4.4.8" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" fill="none"/><path d="M4.6 21c1-.2 1.9-.6 2.7-1.2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" opacity="0.45"/>', draw: { type: 'path' } },
            { id: 'fountain-pen', label: 'Fountain', row: 1, icon: '<path d="M12 3l5 5-5 11-5-11 5-5Z" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linejoin="round"/><path d="M12 3v12" stroke="currentColor" stroke-width="1"/><circle cx="12" cy="10.4" r="1.15" fill="currentColor"/><path d="M4 21c1.8-2.3 4.6-3.4 8-3.4S18.2 18.7 20 21" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" fill="none"/>', draw: { type: 'path' } },
            { id: 'pencil-pen',   label: 'Pencil',   row: 1, icon: '<path d="M16.8 3.8L20.2 7.2L9.2 18.2H5.8V14.8L16.8 3.8Z" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linejoin="round"/><path d="M16.8 3.8L20.2 7.2L21.4 6l-3.4-3.4Z" fill="currentColor" opacity="0.55"/><path d="M5.8 14.8L4.2 19.8L9.2 18.2Z" fill="currentColor" opacity="0.35"/><path d="M4.2 21l8-1.6" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" stroke-dasharray="1.2 1.8" opacity="0.75"/>', draw: { type: 'path' } },
    ...
    },
    {
        ...
        tools: [
            ...
            { id: 'koppa', label: 'Thumb(Q)', row: 1, icon: '<text x="12" y="17" font-family="serif" font-weight="400" text-anchor="middle" fill="currentColor" stroke="none">ϙ</text>', draw: { type: 'text', content: 'ϙ', font: '400', size: 20, fontFace: 'serif' } },
