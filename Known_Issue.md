...
* [ ] iPad 無法Page 無法往上捲, 手勢沒作用, 會變成 Browser 的scrolling
* [ ] iPad tool bar 無法移動

* [ ] iPad 上, 左上功能 Bar 太粗, 蓋到樂譜, 希望可以縮小甚至 縮小到單一 icon 化
* [ ] [Fixed] 左上放大倍率的文字太大了, 請縮小

* [ ] iPad 上/下一頁的手勢要定義, 且寫在 keyboard shortcut help 裡面,
...
1. [ ] 增加小節數工具, 預設在頁面最左邊空白處的 Text Box, 然後使用者 intial 一個數字後, 連續輸入單行小節數, 自動加總, 產生新的 Text Box 往下平移.
1. [ ] 增加打包給老師 review 的功能
1. [ ] 樂團功能
